...
public class UserDaoImpl implements UserDao {
    ...
    public void deleteById(Integer id) {
        Connection connection=DBSingleton.getConnection();
        try {
            PreparedStatement pstm= connection.prepareStatement("DELETE FROM user WHERE"+" ID_USER=?");
            pstm.setInt(1,id);
            pstm.executeUpdate();
    ...
    public void update(User o) {
        Connection connection=DBSingleton.getConnection();
        try {
            PreparedStatement pstm= connection.prepareStatement("update username=?,password=? FROM user WHERE "+" ID_USER=?");
